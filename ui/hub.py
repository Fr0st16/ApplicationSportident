...
from ui.hub_view import HubViewMixin
from ui.hub_validation import HubValidationMixin


class HubMixin(HubViewMixin, HubValidationMixin):
    ...
    La construction des widgets du hub vient de HubViewMixin
    (ui/hub_view.py), et le dialogue de validation en mode contrôlée de
