...
from ui.lecture_puce_reader import ReaderMixin


class AppLecturePuce(tk.Frame, ReaderMixin):
    ...
    La connexion/lecture série (thread, protocole) est fournie par ReaderMixin
    (ui/lecture_puce_reader.py)."""
